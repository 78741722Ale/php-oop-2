...
$istanza_user = new User('Alessandro', 'Pecorilla', 27, 'Via Leonardo Da Vinci 5', 'prova@prova.com', 'Bancomat', 20, 555, 'Alessandro', 'Password');
var_dump("Questa è l'istanza di User");
var_dump($istanza_user);
/********/
var_dump($istanza_user->setIdUser());  // Qua richiamo la funzione interna di Products
var_dump($istanza_user->getIdUser(true));
